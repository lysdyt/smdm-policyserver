...
/**
 * Abstract class representing the encoding scheme used to create an update
 * bundle for loading.
 */
abstract class Encoding {

	static final int initialCapacity = 2;
	public static final Map<String, Encoding> encodeFunctions = new HashMap<String, Encoding>(
			initialCapacity);
	...
	/**
	 * Given a File object encode it according to a given bundle scheme capable
	 * of being loaded by the ConfigUpdate mechanism.
	 * 
	 * @param path
	 *            File object of the file to encode.
	 * 
	 * @exception IOException
	 *                produced by failed or interrupted I/O operations on the
	 *                requested path or if the passed path is null.
	 * 
...
class Base64Encoding extends Encoding {
	...
	/**
	 * Given a File object encode it as base64 chunked, line wrapped at 76
	 * characters, with each line ending in '\n'. A byte array of the encoded
	 * file is returned.
	 * 
	 * @param path
	 *            File object of the file to encode.
