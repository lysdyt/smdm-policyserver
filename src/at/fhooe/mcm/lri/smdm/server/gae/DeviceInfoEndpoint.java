...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "fhooe.at", ownerName = "fhooe.at", packagePath = "mcm.lri.smdm"))
public class DeviceInfoEndpoint {
	...
	/**
	 * Checks if the entity manager contains a specific device information. 
	 * 
	 * @param deviceinfo the information to check
	 * @return if the info is contained or not
	 */
	...
	/**
	 * Returns the entity manager based on the EMF singleton. 
